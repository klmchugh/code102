...
// DONE TODO: Add an "else if" block to check whether it's Saturday
//       and console.log() a different statement for the weekend.



// DONE TODO: Modify the conditional for Saturday to check whether
//       the day is Saturday OR Sunday.



// DONE TODO: Add an "else if" block to check whether it's Monday
//       and console.log() a different statement for Monday.



// DONE TODO: Change the string that's assigned into the day
...
if (days[dayNumber] === 'Thursday') {
  console.log('Is it Friday yet?');
} else if (days[dayNumber] === 'Saturday' || days[dayNumber] === 'Sunday') {
  console.log('Friday already happened, welcome to the weekend.');
} else if (days[dayNumber] === 'Monday') {
